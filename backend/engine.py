"""ตรรกะการให้คะแนนและค่าคงที่ที่ทุกโมดูลใช้ร่วมกัน — ไม่ import โมดูลอื่นในโปรเจกต์"""

# แหล่งที่มาของ XP ที่นับเป็นคะแนนสะสมของนักเรียน
#
# เคยกระจายอยู่หลายไฟล์แล้วลอกกันไม่ครบ course_routes ตกซูโดกุไป XP บนหน้าจัดการ
# รายวิชาจึงไม่ตรงกับหน้าอื่น รวมไว้ที่เดียวเพื่อไม่ให้หลุดกันอีก
XP_SOURCES = ('mission', 'teacher_bonus', 'mcq_mission', 'sudoku_mission')
