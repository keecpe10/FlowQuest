...
/**
 * จัดการกรณีนักเรียนเข้าด่านที่ครูยังไม่เปิด
 *
 * คืน true เมื่อจัดการ 403 ไปแล้ว (ผู้เรียกควรหยุดทำงานต่อ)
 * คืน false เมื่อเป็น error อื่น (ผู้เรียกจัดการเองตามเดิม)
 */
...
/**
 * เวอร์ชันสำหรับโค้ดที่ใช้ fetch() แทน axios จึงมีแค่ status code
 */
